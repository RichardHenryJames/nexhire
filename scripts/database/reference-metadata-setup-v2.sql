...
('JobRole', '.NET Developer', 'Backend Development', '.NET framework specialist'),
...
-- Human Resources
('JobRole', 'HR Generalist', 'Human Resources', 'Handles core HR operations and policies'),
('JobRole', 'HR Specialist', 'Human Resources', 'Specialist in a specific HR function'),
('JobRole', 'HR Coordinator', 'Human Resources', 'Supports HR programs and administration'),
('JobRole', 'HR Manager', 'Human Resources', 'Manages HR team and HR operations'),
('JobRole', 'Senior HR Manager', 'Human Resources', 'Leads HR operations and strategic HR initiatives'),
('JobRole', 'HR Business Partner', 'Human Resources', 'Partners with business leaders on people strategy'),
('JobRole', 'People Operations Specialist', 'Human Resources', 'Manages people ops programs and employee experience'),
('JobRole', 'People Operations Manager', 'Human Resources', 'Leads people ops and employee experience programs'),
('JobRole', 'Talent Acquisition Specialist', 'Human Resources', 'Sources and hires talent'),
('JobRole', 'Talent Acquisition Manager', 'Human Resources', 'Leads recruiting and hiring strategy'),
('JobRole', 'Technical Recruiter', 'Human Resources', 'Recruits technical roles'),
('JobRole', 'Recruiter', 'Human Resources', 'Owns end-to-end recruiting process'),
('JobRole', 'Senior Recruiter', 'Human Resources', 'Leads complex hiring and mentoring'),
('JobRole', 'Sourcer', 'Human Resources', 'Finds and engages candidates'),
('JobRole', 'Recruitment Coordinator', 'Human Resources', 'Coordinates interviews and recruiting operations'),
('JobRole', 'Employer Branding Specialist', 'Human Resources', 'Builds employer brand and recruiting marketing'),
('JobRole', 'Compensation & Benefits Specialist', 'Human Resources', 'Manages comp and benefits programs'),
('JobRole', 'Payroll Specialist', 'Human Resources', 'Manages payroll operations'),
('JobRole', 'HR Analyst', 'Human Resources', 'Analyzes HR metrics and reporting'),
('JobRole', 'Learning & Development Specialist', 'Human Resources', 'Builds employee training and development programs'),
('JobRole', 'Learning & Development Manager', 'Human Resources', 'Leads learning and development strategy'),
('JobRole', 'Employee Relations Specialist', 'Human Resources', 'Handles employee relations and workplace concerns'),
('JobRole', 'Diversity & Inclusion Manager', 'Human Resources', 'Leads D&I programs and initiatives'),
('JobRole', 'HR Director', 'Human Resources', 'Directs HR strategy and operations'),
('JobRole', 'VP of Human Resources', 'Human Resources', 'Executive leadership for HR'),
('JobRole', 'Chief People Officer', 'Human Resources', 'Executive leader for people strategy'),
-- Support & Operations

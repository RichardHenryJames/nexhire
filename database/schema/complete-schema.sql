...
IF NOT EXISTS (SELECT * FROM sys.foreign_keys WHERE name = 'FK_ManualPayment_ApprovedBy')
BEGIN
    ALTER TABLE ManualPaymentSubmissions ADD CONSTRAINT FK_ManualPayment_ApprovedBy

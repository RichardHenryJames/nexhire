...
const DEFAULT_PRICING = {
  ...
  AI_RESUME_FREE_USES: 100,
  // LinkedIn Optimizer
  LINKEDIN_OPTIMIZER_FREE_USES: 100,
  LINKEDIN_OPTIMIZER_COST: 29,
  // Blind Review
  BLIND_REVIEW_FREE_USES: 100,
  BLIND_REVIEW_COST: 49,
  // Resume Builder Premium (watermark-free export)
  RESUME_BUILDER_PREMIUM_COST: 49,
  RESUME_BUILDER_PREMIUM_DURATION_HOURS: 168, // 7 days
};
...
export class PricingService {
  ...
  /**
   * Get resume builder premium cost
   */
  static async getResumeBuilderPremiumCost(): Promise<number> {
    return this.getSetting('RESUME_BUILDER_PREMIUM_COST');
  }

  /**
   * Get resume builder premium access duration in hours
   */
  static async getResumeBuilderPremiumDurationHours(): Promise<number> {
    return this.getSetting('RESUME_BUILDER_PREMIUM_DURATION_HOURS');
  }

...
export class UserService {
     ...
     */
    static async register(userData: any, requestMeta?: { ipAddress?: string | null; userAgent?: string | null }): Promise<User> {
        ...
        try {
            ...
            const termsVersion = userData.termsVersion || appConstants.legal.TERMS_VERSION;
            const privacyPolicyVersion = userData.privacyPolicyVersion || appConstants.legal.PRIVACY_POLICY_VERSION;
            ...
            const userQuery = `
                INSERT INTO Users (
                    ...
                    TwoFactorEnabled, LoginAttempts, ReferredBy, LastLoginAt,
     ...
     */
    static async registerWithGoogle(googleData: any, requestMeta?: { ipAddress?: string | null; userAgent?: string | null }): Promise<{ user: Omit<User, 'Password'>; tokens: any }> {
        ...
        try {
            ...
            const userQuery = `
                INSERT INTO Users (
                    ...
                    'Public', GETUTCDATE(), GETUTCDATE(), 1,
                    0, 0, @param10, @param11, 'Google', @param12, GETUTCDATE(),
     ...
     * Called when existing users need to re-accept after a version change.
     */
    static async acceptTerms(
        userId: string, 
        data: { termsVersion: string; privacyPolicyVersion: string },
        requestMeta?: { ipAddress?: string | null; userAgent?: string | null }
    ): Promise<void> {
        const termsVersion = data.termsVersion || appConstants.legal.TERMS_VERSION;

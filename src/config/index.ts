...
export const dbConfig = {
    ...
    options: {
        ...
        pool: {
            ...
            idleTimeoutMillis: 60000  // PERF: Was 30s — Azure Functions idle up to 5 min
        }
    }
};
...
export const jwtConfig = {
    secret: (() => {
        ...
        if (!secret) {
            throw new Error('FATAL: JWT_SECRET environment variable is not set. Cannot start application without a secure JWT secret.');
        }
        return secret;
    })(),

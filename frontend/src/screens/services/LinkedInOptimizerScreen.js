...
const SERVICE_NAME = 'LinkedInOptimizer';
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.content}>
        ...
        <Text style={[styles.title, { color: colors.text }]}>LinkedIn Optimizer</Text>
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
          Paste your LinkedIn URL — AI audits your headline, summary, and skills, then generates an optimized profile in one click.
        </Text>

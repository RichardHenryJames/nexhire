...
const SERVICE_NAME = 'OfferCoach';

export default function OfferCoachScreen({ navigation }) {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.content}>
        ...
        <Text style={[styles.title, { color: colors.text }]}>Offer Coach</Text>
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
          Upload your offer letter — AI tells you exactly what to negotiate, how much to push, and gives you ready-to-send email templates.
        </Text>

...
const SERVICE_NAME = 'MarketPulse';

export default function MarketPulseScreen({ navigation }) {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.text }]}>Market Pulse</Text>
      ...
      <View style={styles.content}>
        ...
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
          Live dashboard of who's hiring, trending roles, salary movements, and layoff alerts — updated daily.
        </Text>

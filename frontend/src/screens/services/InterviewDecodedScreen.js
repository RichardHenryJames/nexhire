...
const SERVICE_NAME = 'InterviewDecoded';

export default function InterviewDecodedScreen({ navigation }) {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <SubScreenHeader title="Interview Prep" fallbackTab="Services" />

      <View style={styles.content}>
        <LinearGradient
          colors={[colors.successDark, colors.successLight]}
          start={{ x: 0, y: 0 }}
          end={{ x: 1, y: 1 }}
        ...
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
          Get role-specific interview questions, model answers, and tips based on your target company — so you walk in prepared.
        </Text>

...
const SERVICE_NAME = 'SalarySpy';

export default function SalarySpyScreen({ navigation }) {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: colors.text }]}>Salary Spy</Text>
      ...
      <View style={styles.content}>
        ...
        <Text style={[styles.title, { color: colors.text }]}>Salary Spy</Text>
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
          See what people at your target company actually earn — crowdsourced from verified employees. Contribute yours to unlock.
        </Text>

...
const SERVICE_NAME = 'CareerSimulator';

export default function CareerSimulatorScreen({ navigation }) {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        <TouchableOpacity onPress={() => navigation.navigate('Services')} style={styles.backBtn}>
          <Ionicons name="arrow-back" size={24} color={colors.text} />
        </TouchableOpacity>
        <Text style={[styles.headerTitle, { color: colors.text }]}>Career Simulator</Text>
      ...
      <View style={styles.content}>
        ...
        <Text style={[styles.title, { color: colors.text }]}>Career Simulator</Text>
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
          AI maps your career path — shows possible next roles, expected salary jumps, and the skills you need to get there.
        </Text>

  ...
  return (
    <View style={styles.container}>
      ...
      <WalletRechargeModal
        ...
        subtitle={`See who viewed your profile for ${pricing.profileViewAccessDurationDays} days`}
        note={`Requires ₹${pricing.profileViewCost}`}
      ...
      >
        <View style={confirmModalStyles.overlay}>
          <View style={confirmModalStyles.card}>
            <View style={confirmModalStyles.header}>
              <Ionicons name="eye" size={28} color={colors.primary} />
              <Text style={confirmModalStyles.headerTitle}>Unlock Profile Views</Text>
            </View>
            <View style={confirmModalStyles.body}>
              <Text style={confirmModalStyles.subtitle}>See who's interested in your profile</Text>
              <View style={confirmModalStyles.benefits}>
                <Text style={confirmModalStyles.benefitsTitle}>What you'll get</Text>
                <Text style={confirmModalStyles.benefitItem}>• See names & photos of people who viewed you</Text>
                <Text style={confirmModalStyles.benefitItem}>• Visit their profiles directly</Text>
                <Text style={confirmModalStyles.benefitItem}>• {pricing.profileViewAccessDurationDays}-day access after purchase</Text>
              </View>
              <View style={confirmModalStyles.kvRow}>
                <Text style={confirmModalStyles.kvLabel}>Cost</Text>
                <Text style={confirmModalStyles.kvValue}>₹{pricing.profileViewCost.toFixed(2)}</Text>
              </View>
              <View style={confirmModalStyles.kvRow}>
                <Text style={confirmModalStyles.kvLabel}>Current Balance</Text>
                <Text style={confirmModalStyles.kvValue}>₹{Number(walletBalance || 0).toFixed(2)}</Text>
              </View>
              <View style={confirmModalStyles.kvDivider} />
              <View style={confirmModalStyles.kvRow}>
                <Text style={confirmModalStyles.kvLabelBold}>Balance After</Text>
                <Text style={confirmModalStyles.kvValueBold}>₹{(Number(walletBalance || 0) - pricing.profileViewCost).toFixed(2)}</Text>
              </View>
              <View style={confirmModalStyles.actions}>
                <TouchableOpacity style={confirmModalStyles.btnSecondary} onPress={() => setShowConfirmModal(false)}>
                  <Text style={confirmModalStyles.btnSecondaryText}>Cancel</Text>
                </TouchableOpacity>
                <TouchableOpacity style={confirmModalStyles.btnPrimary} onPress={handleConfirmPurchase}>
                  <Text style={confirmModalStyles.btnPrimaryText}>Proceed</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>

  ...
  return (
    <TouchableOpacity style={styles.applicationCard} onPress={onPress}>
      <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 6, gap: 10 }}>
        {logo ? (
          <CachedImage source={{ uri: logo }} style={{ width: 32, height: 32, borderRadius: 8, backgroundColor: '#f0f0f0' }} resizeMode="contain" />
        ) : (
          <View style={{ width: 32, height: 32, borderRadius: 8, backgroundColor: colors.gray200, justifyContent: 'center', alignItems: 'center' }}>

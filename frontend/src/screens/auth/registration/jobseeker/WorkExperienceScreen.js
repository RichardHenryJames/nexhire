...
const createStyles = (colors, responsive = {}) =>
  StyleSheet.create({
    ...
    modalAccentLine: { height: 3, width: '100%', backgroundColor: colors.primaryGlowStrong },
    modalHeader: {
    ...
    orgItem: {
      ...
      backgroundColor: 'rgba(255,255,255,0.03)', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.04)',
    },
    orgItemLogo: { width: 40, height: 40, borderRadius: 10, marginRight: 12, backgroundColor: colors.white, borderWidth: 1, borderColor: 'rgba(255,255,255,0.06)' },
    orgItemLogoPlaceholder: { width: 40, height: 40, borderRadius: 10, marginRight: 12, backgroundColor: 'rgba(255,255,255,0.05)', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'rgba(255,255,255,0.04)' },
    orgItemName: { fontSize: 15, fontWeight: '600', color: '#e0e0e0' },
    orgItemIndustry: { fontSize: 13, color: 'rgba(255,255,255,0.4)', marginTop: 2 },
  });

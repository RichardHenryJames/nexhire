    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          answer: 'Good news - you only pay when someone actually refers you!\n• When you request a referral, the amount is HELD (not charged)\n• If someone refers you within 2 weeks, the hold is converted to a charge\n• If no one refers you, the hold is automatically released\n• Your money stays safe in your wallet\n• You can cancel pending requests anytime to release the hold immediately'
        },
        {
          question: 'What are the cancellation charges for a referral request?',
          answer: 'You can withdraw (cancel) a referral request anytime. A tiered cancellation fee applies based on how long ago you submitted the request:\n\n• Within 1 hour — ₹0 (Free). Full held amount is released back to your wallet. This is a grace period so you can cancel risk-free if you change your mind.\n• 1 to 24 hours — ₹10 fee. The remainder is released back to your wallet. A small fee is charged because your request may have already been viewed by referrers.\n• After 24 hours — ₹20 fee. The remainder is released back to your wallet. A higher fee applies as a referrer may have already started working on your referral.\n\nThe fee is automatically deducted from the held amount and the remainder is released to your wallet instantly. You can see the exact fee before confirming the cancellation.\n\n💡 Tip: You don\'t need to cancel just to get your money back. If no referrer picks up your request within 2 weeks, the system automatically refunds the full held amount to your wallet — no action needed from your side.'
        },
        {

                ...
                {proofImage ? (
                  ...
                  <>
                    <TouchableOpacity 
                      ...
                      disabled={uploading}
                    >
                      <Ionicons name="camera-outline" size={32} color={proofError ? colors.error : colors.gray600} />
                      <Text style={[styles.uploadButtonText, proofError && { color: colors.error }]}>Add Screenshot</Text>
                      <Text style={styles.uploadButtonSubtext}>Take a photo or choose from gallery</Text>
                    </TouchableOpacity>
                    {proofError && (

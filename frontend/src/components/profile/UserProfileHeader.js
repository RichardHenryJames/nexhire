...
export default function UserProfileHeader({ 
  ...
  currentWorkLogo = null, // Company logo URL for verified referrer badge
  currentWorkCompany = null, // Company name for verified referrer toast
  ...
  const showImagePicker = () => {
    // Direct to OS picker — it already shows Take Photo, Photo Library, Choose File, etc.
    pickImage('library');
  };

...
const linking = {
  ...
  config: {
    screens: {
      // Public screens - accessible without auth (SEO-friendly URLs)
      // *Public suffix = same pattern as AskReferralPublic / JobDetailsPublic
      Terms: "terms",
      ...
      // Public Tools - accessible without auth
      ...
      // Public Blog - accessible without auth
      BlogPublic: "blog",
      ...
      Main: {
        ...
        screens: {
          ...
          // Service/Tool screens — auth-only internal URLs
          // (public SEO URLs at root level use *Public screen names)
          ResumeAnalyzer: "t/resume-analyzer",
          ResumeBuilder: "t/resume-builder",
          LinkedInOptimizer: "t/linkedin-optimizer",
          ATSBeatSheet: "t/ats-beat-sheet",
          InterviewDecoded: "t/interview-prep",
          ...
          Careers: "t/careers",
          CareerJobDetail: "t/careers/job/:jobId",

          // Pages — auth-only internal URLs
          Support: "p/support",
          FAQ: "p/faq",
          Pricing: "p/pricing",
          Blog: "p/blog",
          BlogArticle: "p/blog/:articleId",
...
function MainTabNavigator() {
  ...
  const screenOptions = useMemo(() => ({ route }) => ({
        ...
        tabBarLabelStyle: {
          ...
          // v7 default (10) is designed to fit perfectly in the 49pt bar
          fontSize: 10,
          fontWeight: "600",
        },
        headerShown: false,
...
function MainStack() {
  ...
  return (
    ...
    >
      ...
      {/* Service/Tool screens — registered here so authenticated users
          stay inside MainStack (DesktopNavBar visible).
          Root-level copies remain for unauthenticated public access. */}
      <Stack.Screen name="ResumeAnalyzer" component={ResumeAnalyzerScreen} options={{ headerShown: false, title: 'Resume Analyzer - AI Job Match Tool' }} />
      <Stack.Screen name="ResumeBuilder" component={ResumeBuilderScreen} options={{ headerShown: false, title: 'Resume Builder - AI Resume Maker | RefOpen' }} />
      ...
      {/* Public pages — also inside MainStack for authenticated nav bar */}
      <Stack.Screen name="Support" component={SupportScreen} options={{ headerShown: false, title: 'Help & Support' }} />
      <Stack.Screen name="FAQ" component={FAQScreen} options={{ headerShown: false, title: 'Frequently Asked Questions' }} />
      <Stack.Screen name="Blog" component={BlogListScreen} options={{ headerShown: false, title: 'Career Blog - Job Search Tips & Advice' }} />
      <Stack.Screen name="BlogArticle" component={BlogArticleScreen} options={{ headerShown: false, title: 'Blog Article' }} />
    </Stack.Navigator>
    </View>
  );
}
...
export default function AppNavigator() {
  ...
  return (
    ...
    >
      ...
      />
      <Stack.Screen name="FAQPublic" component={FAQScreen} options={{ headerShown: false, title: 'Frequently Asked Questions' }} />
      <Stack.Screen name="PricingPublic" component={PricingScreen} options={{ headerShown: false, title: 'Pricing - RefOpen Referral & AI Tools' }} />
      ...
      {/* Public Tool screens - accessible without auth */}
